 ...
 */
class Solution {
    // Main method to find the lowest common ancestor of the deepest leaves
    public TreeNode lcaDeepestLeaves(TreeNode root) {
        // Start DFS and return the LCA node
        return (TreeNode) dfs(root)[0];
    }

    // DFS function to find the LCA of the deepest leaves
